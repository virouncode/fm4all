      ...
      render={({ field }) => (
        <FormItem className={containerClassName}>
          ...
          <FormControl>
            <Input
              id={nameInSchema}
              className={`w-full max-w-xs read-only:pointer-events-none read-only:text-slate-400 disabled:text-blue-500 disabled:opacity-75 dark:disabled:text-yellow-300 ${className}`}
              {...props}
