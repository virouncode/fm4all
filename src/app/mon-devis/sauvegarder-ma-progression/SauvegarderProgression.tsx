            ...
            >
              ...
              <div className="w-full flex flex-col gap-6">
                ...
                <ul className="flex flex-col gap-2 ml-16">
                  ...
                  <li className="list-handshake">
                    Engagement N°2 : Sans engagement ! Créer un devis
                    personnalisé est gratuit et ne vous engage à rien
                  </li>
                  <li className="list-handshake">
                    Engagement N°3 : Pas de SPAM, vos informations sont
                    sécurisées par fm4all et ne seront ni partagées, ni
                    utilisées à des fins de prospection par un tiers
                  </li>
                </ul>
              </div>
              <div className="flex gap-4 items-center">
                ...
                <Label htmlFor="acceptation">
                  ...
                  par fm4all dans le cadre de ma demande et conformément à sa{" "}
                  <Link
