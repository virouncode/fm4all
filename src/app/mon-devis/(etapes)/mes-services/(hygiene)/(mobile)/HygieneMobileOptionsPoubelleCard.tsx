...
type HygieneMobileOptionsPoubelleCardProps = {
  proposition: {
...
const HygieneMobileOptionsPoubelleCard = ({
  proposition,
  handleClickProposition,
}: HygieneMobileOptionsPoubelleCardProps) => {
  ...
  const prixMensuelPoubelleText = totalPoubelle ? (
    <p className="text-sm font-bold">
      {formatNumber(Math.round((totalPoubelle * MARGE) / 12))} €/mois
    </p>
  ) : (
  ...
  const imgProduit = (
    <div className="w-1/3 h-full relative rounded-xl overflow-hidden">
      <Image
        ...
        alt={`illustration de distributeur de poubelle`}
        fill={true}
...
export default HygieneMobileOptionsPoubelleCard;
