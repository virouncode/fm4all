    ...
    <div className="grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-6 items-center mt-6 w-full">
      ...
      >
        <div className="p-4 flex flex-col gap-4 h-52">
          ...
          <div className="flex-1">
            <Link className="underline" href="/articles/lexternalisation-du-fm">
              Lire l&apos;article
            </Link>
          </div>
        </div>
      ...
      >
        <div className="p-4 flex flex-col gap-4 h-52">
          ...
          <p className="overflow-hidden text-ellipsis">
            ...
            l&apos;on mesure et avoir des attentes réa...
          </p>
          <div className="flex-1">
            <Link
              className="underline"
      ...
      >
        <div className="p-4 flex flex-col gap-4 h-52">
          ...
          <div className="flex-1">
            <Link className="underline" href="/articles/histoire-du-nettoyage">
              Lire l&apos;article
            </Link>
          </div>
        </div>
