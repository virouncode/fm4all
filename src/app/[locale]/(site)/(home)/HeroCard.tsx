...
const HeroCard = async () => {
  ...
  return (
    <div className="flex animate-appear flex-col gap-6 rounded-xl border border-white/20 bg-blue-500/10 p-6 text-base backdrop-blur-xl">
      ...
      <div className="flex justify-center">
        <ul className="mb-6 space-y-4">
          <li className="list-check flex items-start">
      ...
      <div className="hidden md:flex md:justify-center">
        <DevisButton
          ...
          size="lg"
          className="border-none bg-fm4alldestructive text-white shadow-lg ring-fm4alldestructive hover:bg-fm4alldestructive/90 hover:shadow-xl"
        />
      </div>
      <div className="md:hidden">
        <DevisButton
          ...
          size="lg"
          className="w-full border-none bg-fm4alldestructive text-white shadow-lg ring-fm4alldestructive hover:bg-fm4alldestructive/90"
        />
      </div>
    </div>
  );
