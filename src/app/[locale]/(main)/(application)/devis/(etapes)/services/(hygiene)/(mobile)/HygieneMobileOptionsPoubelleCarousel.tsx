...
import HygieneMobileOptionsPoubelleCard from "./HygieneMobileOptionsPoubelleCard";

type HygieneMobileOptionsPoubelleCarouselProps = {
  propositions: {
...
const HygieneMobileOptionsPoubelleCarousel = ({
  propositions,
  handleClickProposition,
}: HygieneMobileOptionsPoubelleCarouselProps) => {
  ...
  }, [api, hygiene.infos.poubelleGammeSelected, hygiene.infos.entrepriseId]);
    ...
    >
      <CarouselContent>
        {propositions.map((proposition) => (
          <HygieneMobileOptionsPoubelleCard
            proposition={proposition}
            handleClickProposition={handleClickProposition}
            key={"poubelle" + proposition.gamme}
          />
        ))}
      </CarouselContent>
...
export default HygieneMobileOptionsPoubelleCarousel;
