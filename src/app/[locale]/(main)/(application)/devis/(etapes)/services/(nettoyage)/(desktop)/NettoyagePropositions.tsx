...
import NettoyageDesktopPropositions2 from "./NettoyageDesktopPropositions2";
...
const NettoyagePropositions = ({
  ...
  console.log("fournisseursIds", fournisseursIds);

  const nettoyageProduitsByFournisseurId = nettoyageProduits.reduce<
    Record<number, SelectNettoyageProduitType[]>
  >((acc, item) => {
  ...
  console.log(
    "nettoyageProduitsByFournisseurId",
    nettoyageProduitsByFournisseurId,
  );
  ...
  //   handleClickProposition={handleClickProposition}
  // />
  return fournisseursIds.map((fournisseurId) => (
    <NettoyageDesktopPropositions2
      nettoyageProduits={nettoyageProduitsByFournisseurId[fournisseurId]}
    />
  ));
};
