...
import UpdateTicketForm from "../../../tickets/[ticketId]/UpdateTicketForm";
          ...
          <div className="w-full max-w-3xl pb-8">
            <div className="mb-6">
              ...
              <p className="text-muted-foreground text-sm">
                Modifiez les détails de la demande ci-dessous
              </p>
            </div>
            <div>
              {sites.length === 0
                ...
                : !initialTicket
                  ? `La ticket ${ticketId} correspondant à cette demande n'existe pas`
          ...
          <div className="w-full max-w-3xl pb-8">
            <div className="mb-6">
              ...
              <p className="text-muted-foreground text-sm">
                {isClientAdmin
                  ? "Modifiez les détails de la demande ci-dessous"
                  : "Vous n'avez pas la permission de modifier cette demande"}
              </p>
            </div>
            <UpdateTicketForm
