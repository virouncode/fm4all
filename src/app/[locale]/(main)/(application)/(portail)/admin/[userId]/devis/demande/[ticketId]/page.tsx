...
const page = async ({
        ...
        <div className="flex min-h-0 flex-1 flex-col">
          <div className="flex min-h-0 flex-1 items-center justify-center p-4">
            <p className="text-muted-foreground">
              La demande de devis n°{ticketId} n&apos;existe pas.
            </p>
          </div>
        </div>
      </main>
  ...
  // Vérifier que c'est bien un ticket de type "demande_devis"
  if (initialTicket.type !== "demande_devis") {
    return (
      <main className="flex h-full w-full flex-col overflow-hidden md:border-x">
        <div className="bg-background/95 shrink-0 border-b">
          <h1 className="py-2 text-center text-xl font-bold">
        ...
        <div className="flex min-h-0 flex-1 flex-col">
          <div className="flex min-h-0 flex-1 items-center justify-center p-4">
            <p className="text-muted-foreground">
              Le ticket n°{ticketId} n&apos;est pas une demande de devis.
            </p>
          </div>
        </div>
      </main>
      ...
      <div className="min-h-0 flex-1 overflow-y-auto">
        <div className="flex justify-center p-6">
          <div className="w-full max-w-3xl pb-8">
            ...
            <div>
              {!client
                ? "Le client associé à cette demande n'existe pas"
                : sites.length === 0
  ...
  return (
    <main className="flex h-full w-full flex-col overflow-hidden">
      <div className="bg-background/95 shrink-0 border-b">
        <h1 className="py-2 text-center text-xl font-bold">
          Demande de devis &quot;{initialTicket.titre}&quot; (n°
          {initialTicket.id})
        </h1>
      </div>
      <div className="min-h-0 flex-1 overflow-y-auto">
          ...
          <div className="w-full max-w-3xl pb-8">
            <div className="mb-6">
              ...
              <p className="text-muted-foreground text-sm">
                ...
                champs sauf le client, le type et la catégorie
              </p>
            </div>
            <AdminUpdateTicketForm
              ...
              userId={userId}
              isDevisTicket={true}
              redirectUrl={`/admin/${userId}/devis/demandes-en-cours`}
            />
          </div>
        </div>
      </div>
