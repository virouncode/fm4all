...
export const getHygieneDistribQuantite = async (effectif: string) => {
  ...
  try {
    ...
    console.error("[queries] getHygieneDistribQuantite a échoué", error);
    return null;
  }
};
...
export const getHygieneDistribTarifs = async () => {
  ...
  try {
    ...
    console.error("[queries] getHygieneDistribTarifs a échoué", error);
    return [];
  }
};
...
export const getHygieneMinFacturation = async () => {
  ...
  try {
    ...
    console.error("[queries] getHygieneMinFacturation a échoué", error);
    return [];
  }
};
...
export const getHygieneMinFacturationPrestataire = async (
  ...
  try {
    ...
    console.error(
      "[queries] getHygieneMinFacturationPrestataire a échoué",
      error,
    );
    return null;
  }
...
export const getHygieneDistribTarifsPrestataire = async (
  ...
  try {
    ...
    console.error(
      "[queries] getHygieneDistribTarifsPrestataire a échoué",
      error,
    );
    return [];
  }
...
export const getHygieneInstalDistribTarifs = async (effectif: string) => {
  ...
  try {
    ...
    console.error("[queries] getHygieneInstalDistribTarifs a échoué", error);
    return [];
  }
};
...
export const getHygieneInstalDistribTarifsPrestataire = async (
  ...
  try {
    ...
    console.error(
      "[queries] getHygieneInstalDistribTarifsPrestataire a échoué",
      error,
    );
    return [];
  }
...
export const getHygieneConsosTarifs = async (effectif: string) => {
  ...
  try {
    ...
    console.error("[queries] getHygieneConsosTarifs a échoué", error);
    return [];
  }
};
...
export const getHygieneConsosTarifsPrestataire = async (
  ...
  try {
    ...
    console.error(
      "[queries] getHygieneConsosTarifsPrestataire a échoué",
      error,
    );
    return [];
  }
