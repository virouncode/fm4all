import { g as Ue } from "./sanity-BMmG2EgQ.js";
function Ge(G, K) {
      ...
      (function (G, K) {
        (function (y) {
          ...
          pe.prototype.decode = function (e) {
            ...
            function n(d, u) {
              if (d === 6 * 1) return u >> 6 > 15 ? 3 : u > 31 ? 2 : 1;
              if (d === 6 * 2) return u > 15 ? 3 : 2;
              if (d === 6 * 3) return 3;
              throw new Error();
            }
            for (
...
var ue, xe;
function We() {
  return (xe || ((xe = 1), (ue = $e().EventSourcePolyfill)), ue);
}
var De = We();
const ze = Ue(De),
  Ke = Ge({ __proto__: null, default: ze }, [De]);
export { Ke as b };
