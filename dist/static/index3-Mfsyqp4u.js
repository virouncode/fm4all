const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      "static/index-K1IaXaKX.js",
      "static/sanity-BMmG2EgQ.js",
      "static/index2-yTGxFWpu.js",
    ]),
) => i.map((i) => d[i]);
import {
  a7 as Oe,
...
function St(t) {
  ...
  e[15] !== b || e[16] !== s
    ? ((C = (v) => {
        b((j, $) => [...j.slice(0, s), { ...$, params: v }, ...j.slice(s + 1)]);
      }),
      (e[15] = b),
      (e[16] = s),
      (e[17] = C))
  ...
  e[22] !== b
    ? ((V = (v) => {
        const j = v === void 0 ? {} : v;
        b(() => [
          { id: j.id || "", payload: j.payload, params: j.params || {} },
        ]);
      }),
      (B = () => {
        b($t);
  ...
  e[31] !== b || e[32] !== s
    ? ((H = (v) => {
        b((j, $) => {
          const M = {
            ...$,
            payload: (v == null ? void 0 : v.payload) || $.payload,
            params: (v == null ? void 0 : v.params) || $.params,
          };
...
const Et = (t) => !!t && typeof (t == null ? void 0 : t.then) == "function",
...
async function Ct(t) {
  ...
  async function o({
    ...
    return y.type === "document" && y.id === P
      ...
      : ((w = y.canHandleIntent) != null &&
            w.call(y, l, u, { pane: y, index: s })) ||
          (y.type === "documentList" &&
            y.schemaTypeName === g &&
  ...
  const a = (
    ...
    i.depthIndex === s.depthIndex
      ? i.levelIndex - s.levelIndex
      : i.depthIndex - s.depthIndex,
  )[0];
  return a ? a.panes : n;
}
...
function te({
  ...
  try {
      ...
      Ie((c) => {
        const d = { type: "resolvedMeta", ...i, paneNode: c, path: u.path },
          x = s.map((f, m) => ({
            ...
            path: [
              ...u.path,
              ...s.slice(m).map((P, g) => `[${f.flatIndex + g}]`),
            ],
            paneNode: null,
            ...f,
          }));
        ...
        return (
          l != null && l.routerPaneSibling.id.startsWith("__edit__")
            ...
            : i.groupIndex === (l == null ? void 0 : l.groupIndex)
              ...
              : (I = te({
                  unresolvedPane:
                    typeof c.child == "function" ? Le(c, "child") : c.child,
                  flattenedRouterPanes: s,
                  parent: c,
                  path: u.path,
                  resolvePane: o,
    ...
    if (
      ...
      (c.context &&
        console.warn(
          `Pane resolution error at index ${c.context.index}${c.context.splitIndex > 0 ? ` for split pane index ${c.context.splitIndex}` : ""}: ${c.message}${c.helpId ? ` - see ${$e(c.helpId)}` : ""}`,
          c,
        ),
...
function Nt() {
  ...
  let r, n;
  (t[0] !== e
    ? ((n = e.asObservable().pipe(F(Ot))), (t[0] = e), (t[1] = n))
    : (n = t[1]),
    (r = n));
  const o = r,
    { state: a } = fe();
...
function At() {
  ...
  t[0] === Symbol.for("react.memo_cache_sentinel")
    ? ((a = { paneDataItems: [], resolvedPanes: [], routerPanes: [] }),
      (t[0] = a))
    : (a = t[0]);
  ...
  const e = t.reduce(Wt, []),
    ...
    n = t.map((o) => {
      ...
      return {
        ...
        pane: o.type === "loading" ? J : o.paneNode,
        params: l.params || {},
        path: u.join(";"),
        payload: l.payload,
...
function Gt(t) {
  ...
  return e
    ? { intent: e, params: xe(t.params) ? t.params : Kt, payload: t.payload }
    : void 0;
}
const Ut = Re.span`
...
function Jt(t) {
  ...
  let s;
  e[0] !== n
    ? ((s = n instanceof de ? n.path : []), (e[0] = n), (e[1] = s))
    : (s = e[1]);
  const l = s,
  ...
  let d;
  e[2] !== o
    ? ((d = o("structure-error.header.text")), (e[2] = o), (e[3] = d))
    : (d = e[3]);
  let x;
  e[4] !== d
    ? ((x = p.jsx(He, { as: "h2", children: d })), (e[4] = d), (e[5] = x))
    : (x = e[5]);
  let I;
  e[6] !== l || e[7] !== o
    ? ((I =
  ...
  let f;
  e[9] !== o
    ? ((f = o("structure-error.error.label")), (e[9] = o), (e[10] = f))
    : (f = e[10]);
  let m;
  e[11] !== f
    ? ((m = p.jsx(N, { size: 1, weight: "medium", children: f })),
      (e[11] = f),
      (e[12] = m))
    : (m = e[12]);
  let P;
  ...
  let g;
  e[17] !== P
    ? ((g = p.jsx(Pe, { children: P })), (e[17] = P), (e[18] = g))
    : (g = e[18]);
  let h;
  e[19] !== m || e[20] !== g
  ...
  return (
    e[34] !== b || e[35] !== x
      ? ((R = p.jsx(ae, {
          ...
          sizing: "border",
          tone: "critical",
          children: p.jsxs(Ee, { children: [x, b] }),
        })),
        (e[34] = b),
        (e[35] = x),
        (e[36] = R))
...
function Xt(t) {
  ...
  let a;
  e[0] !== n
    ? ((a = (xe(n) && n.type) || null), (e[0] = n), (e[1] = a))
    : (a = e[1]);
  const i = a,
    { t: s } = re(se);
  let l;
  e[2] !== s
    ? ((l = s("panes.unknown-pane-type.title")), (e[2] = s), (e[3] = l))
    : (l = e[3]);
  let u;
  e[4] !== l
    ? ((u = p.jsx(mt, { title: l })), (e[4] = l), (e[5] = u))
    : (u = e[5]);
  let c;
  e[6] !== s || e[7] !== i
    ? ((c = p.jsx(ht, {
...
const Zt = {
    component: S.lazy(() =>
      Z(() => import("./index-K1IaXaKX.js"), __vite__mapDeps([0, 1])),
    ),
    document: S.lazy(() =>
      Z(() => import("./sanity-BMmG2EgQ.js").then((t) => t.bc), []).then(
        function (t) {
          return t.pane;
        },
      ),
    ...
    list: S.lazy(() =>
      Z(() => import("./index2-yTGxFWpu.js"), __vite__mapDeps([2, 1])),
    ),
  },
  en = S.memo(
    function (t) {
    ...
    (
      { params: t = {}, payload: e = null, ...r },
      { params: n = {}, payload: o = null, ...a },
    ) => {
...
function tn() {
  ...
  let o;
  t[3] !== n
    ? ((o = p.jsx(N, { as: "h1", size: 1, weight: "medium", children: n })),
      (t[3] = n),
      (t[4] = o))
    : (o = t[4]);
  let a;
  t[5] !== e
    ? ((a = e("no-document-types-screen.subtitle")), (t[5] = e), (t[6] = a))
    : (a = t[6]);
  let i;
  t[7] !== a
    ? ((i = p.jsx(N, { as: "p", muted: !0, size: 1, children: a })),
      (t[7] = a),
      (t[8] = i))
    : (i = t[8]);
  let s;
...
const nn = (t) => {
    const e = E.c(7),
      ...
      I = l
        ? s("browser-document-title.new-document", {
            schemaType:
              (c == null ? void 0 : c.title) || (c == null ? void 0 : c.name),
          })
        : (d == null ? void 0 : d.title) ||
          s("browser-document-title.untitled-document"),
      f = a.ready && !x,
      m = ze(I);
    let P;
    e[0] !== m || e[1] !== f
  ...
  an = (t) => {
    ...
    return (
      e[6] !== o
        ? ((a = p.jsx(ue, { title: o })), (e[6] = o), (e[7] = a))
        : (a = e[7]),
      a
    );
  };
  ...
  dn = S.memo(function (t) {
    ...
    if (
      (e[8] !== n
        ...
        : ((w = e[9]), (_ = e[10])),
      S.useEffect(w, _),
      !((q = o._original) != null && q.types.some(Je)))
    ) {
      let D;
      return (
    ...
    let k;
    e[24] !== l
      ? ((k = p.jsx(an, { resolvedPanes: l })), (e[24] = l), (e[25] = k))
      : (k = e[25]);
    let z;
...
function yn(t) {
  ...
  if (f) {
    ...
    return (
      e[4] !== f
        ? ((w = p.jsx(Jt, { error: f })), (e[4] = f), (e[5] = w))
        : (w = e[5]),
      w
    );
  }
