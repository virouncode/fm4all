import { i as I, c as H } from "./sanity-BMmG2EgQ.js";
const D = /_key\s*==\s*['"](.*)['"]/;
function K(t) {
  return typeof t == "string"
    ? D.test(t.trim())
    : typeof t == "object" && "_key" in t;
}
function L(t) {
...
function ct(t, e, r) {
    ...
    return (
      (u = n == null ? void 0 : n.error) == null ||
        u.call(
          ...
          { result: t, resultSourceMap: e, config: r },
        ),
      t
    );
  if (!r.studioUrl) {
      ...
      ({ sourcePath: a, sourceDocument: _, resultPath: b, value: c }) => {
        if (
          (typeof i == "function"
            ...
            : T({ sourcePath: a, resultPath: b, value: c })) === !1
        )
          return (
            n &&
              o.skipped.push({
  ...
  if (n) {
    ...
    if (
      ...
      (w = n == null ? void 0 : n.log) == null ||
        w.call(n, "[@sanity/client]: List of skipped paths", [...b.values()]);
    }
